...
(function () {
  ...
  // Update rating display with current skill score
  function updateRatingWithCurrentSkills() {
    const totalScore = calculateTotalSkillScore();
    lastSkillScore = totalScore;
    updateRatingDisplay();
  }
